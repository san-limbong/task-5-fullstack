            ...
            <form method="POST" action="/home/articles/{{ $article->id }}" class="mb-5" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <div>
                        ...
                        <img class="img-preview img-fluid mb-3 col-sm-5" src="{{ $article->image ? asset('assets/' . $article->image) : '' }}" style="max-height: 240px; max-width: 12rem;">
                    </div>
                ...
                <div class="d-flex bd-highlight mb-3">
                    ...
                    <div class="ms-auto p-2 bd-highlight"><button type="submit" class="btn btn-warning">Save Changes</button></div>
                </div>
            </form>
        </div>
    </div>
