...
@section('container')
<h1 class="mb-3 text-center">Article Category:{{ $title }}</h1>

@if ($articles->count())
<div class="card mb-3">
    @if($articles[0]->image)
    <img src="{{ asset('assets/' . $articles[0]->image) }}" alt="{{ $articles[0]->category->name }}" class="card-img-top">
    @else
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-3">
            <div class="card">
                ...
                @if($article->image)
                <img src="{{ asset('assets/' . $article->image) }}" alt="{{ $article->category->name }}" class="card-img-top">
                @else
